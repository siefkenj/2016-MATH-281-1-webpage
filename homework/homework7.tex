...
%%%
\begin{document}
	\setheader{Math 281-1}{Homework 7}{Due: Thursday, November 10}{}{}{}
	\begin{enumerate}
		\item 
		\begin{enumerate}
		...
		\item If possible, write down an equation of the tangent plane (in vector form) at the minimum and maximum points
		...
		\item Let $C$ be a circular path in $\R^3$ that passes through the points
			...
			Let $f:\R^3\to\R$ be distance from the origin.  That is, $f(\vec x) = \|\vec x\|$.
		\begin{enumerate}
